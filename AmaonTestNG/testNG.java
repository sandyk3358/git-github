...
public class testNG
{
	...
	public void ordersTab() throws InterruptedException
	{
		...
		//Select dropdown = new Select(driver.findElement(By.xpath("//*[@id=\"a-autoid-1-announce\"]/span")));
		//dropdown.selectByValue("{\"stringVal\":\"year-2017\"}");
		for(int i=0; i<=4; i++)
			/* i = 0 - Last 30 days
			 * i = 1 - Last 6 Months
			 * i = 2 - 2017
			 ...
			 */
		{
			...
			driver.findElement(By.id("orderFilter_" +i)).click();
			Thread.sleep(2000);
		
			//Scroll down
			//JavascriptExecutor jse = (JavascriptExecutor)driver;
			//jse.executeScript("window.scrollBy(0,100)", "");
			((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView();", driver.findElement(By.xpath("//*[@id=\"navBackToTop\"]/div/span")));
	...
	public void browsingHistory()
	{
			...
			driver.findElement(By.xpath(".//*[@id='ybh_center']/div[1]/a/span/div/div/div[2]/span")).click();
			//Delete browsing history
			driver.findElement(By.xpath(".//*[@id='btn_clear']/span/input ")).click();
